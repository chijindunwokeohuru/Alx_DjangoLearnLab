#!/usr/bin/env python
"""
Security Test Script for Django LibraryProject
...
def test_security_headers():
    ...
    try:
        ...
        response = requests.get("http://127.0.0.1:8000/bookshelf/", timeout=5)
        ...
        with open(templates[0], 'r') as f:
            ...
            for header in security_headers:
                if header in content:
                    print(f"✓ {header} meta tag found in templates")
                else:
                    print(f"○ {header} meta tag not found (handled by middleware)")
...
def main():
    ...
    tests = [
        ...
        # test_security_headers,  # Commented out as it requires server to be running
    ]
